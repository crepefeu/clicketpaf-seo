...
export default function Blockquote({ quote, author }: BlockquoteProps) {
  return (
    <div>
      <blockquote className="relative italic bg-green-100 border-2 border-green-600  mt-3 rounded-lg p-6 w-9/12 mx-auto">
        <svg
      ...
      <p className="text-gray-500 font-light italic mt-2 mb-4 w-9/12 mx-auto">
        {author}
      </p>
    </div>
  );
